...
const NAV: NavItem[] = [
  ...
  { href: '/admin/devocional/nuevo', label: 'Nuevo devocional', roles: ['LEADER', 'ADMIN', 'DEVELOPER'] },
  { href: '/admin/calificaciones', label: 'Calificaciones', roles: ['LEADER', 'ADMIN', 'DEVELOPER'] },
  { href: '/admin/seguimiento', label: 'Seguimiento', roles: ['LEADER', 'ADMIN', 'DEVELOPER'] },
  { href: '/admin/configuracion', label: 'Iglesia', roles: ['ADMIN', 'DEVELOPER'] },
